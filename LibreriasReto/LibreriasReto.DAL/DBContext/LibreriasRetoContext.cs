...
namespace LibreriasReto.DAL.DBContext;
...
public partial class LibreriasRetoContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdAcceso).HasName("PK__acceso__FF937662DFABE753");
            ...
            entity.HasOne(d => d.IdEmpleadoNavigation).WithMany(p => p.Accesos)
                ...
                .HasConstraintName("FK__acceso__idEmplea__60A75C0F");
        });
        ...
        {
            entity.HasKey(e => e.IdComprobante).HasName("PK__comproba__BF4D8CF32792ADBE");
            ...
            entity.HasOne(d => d.IdClienteNavigation).WithMany(p => p.Comprobantes)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__comproban__idCli__6383C8BA");

            entity.HasOne(d => d.IdEmpleadoNavigation).WithMany(p => p.Comprobantes)
                .HasForeignKey(d => d.IdEmpleado)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__comproban__idEmp__6477ECF3");

            entity.HasOne(d => d.IdMetodoPagoNavigation).WithMany(p => p.Comprobantes)
                .HasForeignKey(d => d.IdMetodoPago)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__comproban__idMet__656C112C");
        });

        modelBuilder.Entity<Empleado>(entity =>
        {
            entity.HasKey(e => e.IdEmpleado).HasName("PK__empleado__5295297CC5CBD5C0");
            ...
            entity.HasOne(d => d.IdAreaNavigation).WithMany(p => p.Empleados)
                ...
                .HasConstraintName("FK__empleado__idArea__5CD6CB2B");
        });
